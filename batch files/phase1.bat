...
REM "C:\Apps\BukkuOps\.venv\Scripts\python.exe" "C:\Apps\BukkuOps\asoft_delivery_orders.py"
REM "C:\Apps\BukkuOps\.venv\Scripts\python.exe" "C:\Apps\BukkuOps\asoft_sales_orders.py"
