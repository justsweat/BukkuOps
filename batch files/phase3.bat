...
REM "C:\Apps\BukkuOps\.venv\Scripts\python.exe" "C:\Apps\BukkuOps\delivery_order.py"
REM "C:\Apps\BukkuOps\.venv\Scripts\python.exe" "C:\Apps\BukkuOps\sales_order.py"
